...
## 什么是 ChatGPT 中文版？
[**ChatGPT 中文版**](https://chat.lanjingai.org) 是由 OpenAI 开发的 ChatGPT 模型的中文使用版本，旨在为中文用户提供更流畅、更精准的智能AI对话体验。   
...
| **[chat.lanjingai.org](https://chat.lanjingai.org)**   | GPT-4, GPT-4o, GPT-o1 | 有       | 邮箱使用 | ⭐⭐⭐⭐⭐  | 支持 GPT-o1 模型，一比一还原官网，可以使用 AI助手、AI插件 |
